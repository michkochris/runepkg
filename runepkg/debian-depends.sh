...
echo -e "${YELLOW}Acquiring supporting artifacts (Bison, Gawk, Debhelper, Ncurses-Dev, etc.)...${RESET}"
sudo apt-get install -y bison gawk texinfo libtool-bin debhelper libncurses-dev
